...
public class RelativeMovement : MonoBehaviour {
	...
	void Update() {
		...
		if (hitGround) {
            ...
            // si on n'est pas au sol, la vitesse verticale est accélérée par la gravité
            ...
            // si on est ici, le raycasting n'a pas détecté le sol, mais la capsule touche le sol
